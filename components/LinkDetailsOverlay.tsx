...
import { X, Calendar, Clock, Users, CheckCircle, AlertCircle, ExternalLink, MessageSquare, FileText } from 'lucide-react';
import { format } from 'date-fns';
import { useRouter } from 'next/navigation';
import { LINK_STATUS, MEETING_TYPES } from '@/shared/constants';

interface LinkDetailsOverlayProps {
  link: any;
  isOpen: boolean;
  onClose: () => void;
}

export default function LinkDetailsOverlay({ link, isOpen, onClose }: LinkDetailsOverlayProps) {
